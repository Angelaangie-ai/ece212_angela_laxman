...
HD_PWD='C:/Users/poudell/Documents/Lab 4/Lab 4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lab4_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lab4_module.tcl -notrace
