...
HD_PWD='C:/Users/poudell/Documents/Lab 4/Lab 4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lab4_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lab4_module.tcl
